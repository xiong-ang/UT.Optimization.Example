...
本文在实践的基础上，总结了单元测试的基本知识，介绍了.Net 单元测试常用Mock框架Rhnio.Mocks的基本用法，并举例说明了怎么样实现代码的可测性。主要用于个人工作记录目的，方便日后参考。
...
* 在单元测试中，我们考虑面向接口编程的原因是，当前部分Mock框架只能做到对接口和类的虚方法进行Mock。因此，为了实现有效Mock，有必要面向接口编程。
